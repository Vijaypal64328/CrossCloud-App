...
export const testimonials = [
    {
        ...
        quote: "Cross Cloud has transformed how our team collaborates on creative assets. The secure sharing and intuitive interface have made file management a breeze.",
        rating: 5
    },
    {
        name: "Sneha Patel",
        ...
        quote: "As a freelancer, I need to share large design files with clients securely. Cross Cloud's simple interface and reasonable pricing make it my go-to solution.",
        rating: 5
    },
    {
        name: "Rohit Singh",
        ...
        quote: "Managing project files across multiple teams used to be a nightmare until we found Cross Cloud. Now everything is organized and accessible exactly when we need it.",
        rating: 4
    }
];
