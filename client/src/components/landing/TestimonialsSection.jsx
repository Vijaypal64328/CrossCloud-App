...
const TestimonialsSection = ({testimonials}) => {
    return (
    <div className="py-20 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 animate-gradient-move overflow-hidden">
                ...
                <div className="relative">
                    <div className="text-center">
                        ...
                        <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-500">
                            See what our users have to say about CrossCloud
                        </p>
                    </div>
